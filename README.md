# Portfolio Website - Al Kubrani Oleo Wulaa
...
├── final/                     # Final result (personal portfolio)
│   ├── index.html
│   └── assets/
│       ├── css/
│       │   └── style.css
...
│           └── profile.jpeg
│
├── starter/                   # Initial template (unedited)
│   ├── index.html
│   └── assets/
│       ├── css/
│       │   └── style.css
...
- **GitHub**: [alkubranioleow](https://github.com/alkubranioleow)

---

**© 2026 Al Kubrani Oleo Wulaa. Created for FlexLabs workshop assignment.**